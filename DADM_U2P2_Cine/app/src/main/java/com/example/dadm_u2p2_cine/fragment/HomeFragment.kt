...
class HomeFragment: Fragment(R.layout.fragment_home) {
    ...
    private fun populateList(): MutableList<Categoria>{
        ...
        peliculas.add(Pelicula(1,"Godzilla vs Kong",
        ...
        peliculas.add(Pelicula(2,"John Wick 3",
        ...
        peliculas.add(Pelicula(3,"Avenges: Endgame",
        ...
        peliculas.add(Pelicula(4,"Spiderman 3",

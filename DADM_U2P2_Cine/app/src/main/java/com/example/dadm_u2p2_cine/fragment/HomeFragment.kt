...
class HomeFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewPeliculas.adapter = RecyclerPeliculasAdapter(requireContext(), populateList())
    ...
    private fun populateList(): MutableList<Categoria>{
        ...
        peliculas.add(Pelicula("Avenges: Endgame", "https://static.wikia.nocookie.net/marvelcinematicuniverse/images/9/9b/Avenger_Endgame_Poster_Oficial.png/revision/latest/scale-to-width-down/1000?cb=20190326185910&path-prefix=es"))
        peliculas.add(Pelicula("Spiderman 3", "https://static.wikia.nocookie.net/spiderman/images/2/2c/Spider-Man_3_Poster.png/revision/latest?cb=20200612203333&path-prefix=es"))
